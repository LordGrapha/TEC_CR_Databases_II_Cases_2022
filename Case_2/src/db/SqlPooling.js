...
var SqlProvider = /** @class */ (function () {
    function SqlProvider() {
        ...
        this.createPooling().then(function (pool) {
            _this.connection = pool;
        });
    }
    SqlProvider.prototype.createPooling = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    return [2 /*return*/, mssql.connect(this.config)];
                }
                catch (error) {
    ...
    SqlProvider.prototype.getConnection = function () {
        return this.connection;
    };
    SqlProvider.getInstance = function () {
        if (!this.instance) {
